export function setLoginSpanFocusStyles() {
    ...
    if (passwordInput == null || input == null) {return}

    passwordInput.addEventListener("focus", () => {
        if (passwordSpan == null) {return}
        passwordSpan.style.border = "2px solid var(--main-color)";
    });

    passwordInput.addEventListener("focusout", () => {
        if (passwordSpan == null) {return}
        passwordSpan.style.border = "2px solid rgb(206, 206, 206)";
    });
    ...
    input.addEventListener("focusout", () => {
        if (span == null) {return}
        span.style.border = "2px solid rgb(206, 206, 206)";
    });
}